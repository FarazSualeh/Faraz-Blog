  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: dbError } = await supabase
        ...
        .insert([
          { name: validData.name, email: validData.email, subject: validData.subject, message: validData.message },
        ]);
              ...
              <div className="space-y-5 sm:space-y-6">
                <a href="mailto:farazsualeh75@gmail.com" className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base">farazsualeh75@gmail.com</p>
                    <p className="text-muted-foreground text-xs sm:text-sm">I'll respond within 24 hours</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm sm:text-base">@editsbyfaraz</p>
                  </div>
                </a>
              </div>
            </div>
