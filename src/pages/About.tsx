    ...
    <div className="min-h-screen bg-background animate-fade-in">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-16 space-y-6 text-muted-foreground animate-slide-up stagger-2">
          <h2 className="text-3xl font-bold text-foreground mb-6">Hey, I'm Faraz 👋</h2>
          <p>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl bg-muted">
              ...
              <p className="text-muted-foreground">React, TypeScript, Next.js, Tailwind CSS, Node.js, Vite, Git</p>
            </div>
            <div className="p-6 rounded-xl bg-muted">
              <h3 className="text-xl font-semibold mb-3">SEO & Analytics</h3>
              <p className="text-muted-foreground">Google Search Console, Ahrefs, SEMrush, Screaming Frog, GA4</p>
            </div>
            <div className="p-6 rounded-xl bg-muted">
              <h3 className="text-xl font-semibold mb-3">Performance</h3>
              <p className="text-muted-foreground">Core Web Vitals, Lighthouse, PageSpeed Insights, WebPageTest</p>
            </div>
            <div className="p-6 rounded-xl bg-muted">
              <h3 className="text-xl font-semibold mb-3">Other</h3>
              <p className="text-muted-foreground">Technical Writing, Content Strategy, UI/UX Design, Figma</p>
            </div>
          </div>
        </section>
        ...
        <section className="text-center py-12 rounded-2xl bg-card">
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-border hover:border-primary hover:bg-muted transition-all flex items-center justify-center hover:scale-110" aria-label="GitHub"><Github className="w-5 h-5" /></a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-border hover:border-primary hover:bg-muted transition-all flex items-center justify-center hover:scale-110" aria-label="LinkedIn"><Linkedin className="w-5 h-5" /></a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-border hover:border-primary hover:bg-muted transition-all flex items-center justify-center hover:scale-110" aria-label="Twitter"><Twitter className="w-5 h-5" /></a>
          </div>
